  ...
  return (
    <div className="w-screen sm:w-3/4 mx-auto mt-4 px-4 py-4 rounded shadow">
      ...
      <p>
        ...
        conditions of your use of the “QuickBites” mobile application (“Mobile
        ...
        (“Operator”, “we”, “us” or “our”). By accessing and using the Mobile
        Application and Services, you acknowledge that you have read,
        understood, and agree to be bound by the terms of this Agreement. If you
        are entering into this Agreement on behalf of a business or other legal
      ...
      <br />
      <h4 className="text-xl font-bold">Links to Other Resources</h4>
      <br />
      <p>
      ...
      <br />
      <h4 className="text-xl font-bold">Changes and Ammendments</h4>
      <br />
      <p>
        We reserve the right to modify this Agreement or its terms relating to
        the Mobile Application and Services at any time, effective upon posting
        of an updated version of this Agreement in the Mobile Application. When
        we do, we will revise the updated date at the bottom of this page.
        Continued use of the Mobile Application and Services after any such
        changes shall constitute your consent to such changes.
      </p>
      <br />
      <h4 className="text-xl font-bold">Acceptance of these Terms</h4>
      <br />
      <p>
      ...
      <br />
      <h4 className="text-xl font-bold">Contacting Us</h4>
      <br />
      <p>
