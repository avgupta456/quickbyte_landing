...
const Privacy = () => {
  return (
    <div className="w-3/4 mx-auto mt-4 px-4 py-4 rounded shadow">
      ...
      <br />
      <p>
        Thank you for choosing QuickBites (“Company”, “we”, “us”, “our”). We are
      ...
      <p>
        ...
        Services (which, as described above, include our App), as well as, any
      ...
      <br />
      <h3 className="text-2xl font-bold">1. WHAT INFORMATION DO WE COLLECT?</h3>
      <br />
      <h4 className="text-xl font-bold">Information automatically collected</h4>
      <br />
      <p>
      ...
      <ul className="list-disc ml-8">
        <li>
          ...
          settings and information about your activity in the App (such as the
          date/time date/time stamp associated with your usage, pages and files
        ...
        <li>
          ...
          App. Depending on the device used, this device data may include
        ...
        <li>
          ...
          settings of the device you use to access the App. For example, we may
          use GPS and other technologies to collect geolocation data that tells
          us your current location (based on your IP address). You can opt out
          of allowing us to collect this information either by refusing access
          to the information or by disabling your Location setting on your
          device. Not however, if you choose to opt out, you may not be able to
      ...
      <br />
      <p>
        <b>In short</b>: We collect information regarding your geo-location,
      ...
      <ul className="list-disc ml-8">
        <li>
          <b>Geo-Location Information</b>. We may request access or permission
          to and track location-based information from our mobile device, either
        ...
        <li>
          <b>Mobile Device Data</b>. We automatically collect device information
          ...
          carrier, and Internet (IP) address (or proxy server). If you are using
          our App, we may also collect information about the phone network
      ...
      <ul className="list-disc ml-8">
        <li>
          ...
          consent to your personal information for a specific purpose
        </li>
        <li>
        ...
        <li>
          ...
          regarding potential violations of our policy, suspected fraud,
      ...
      <p>
        ...
        transferred to, stored, and processed by using our facilities and by
      ...
      <p>
        ...
        with this privacy notice and applicable laws.
      </p>
      <br />
      <h3 className="text-2xl font-bold">
      ...
      <br />
      <h3 className="text-2xl font-bold">6. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
      <br />
      <p>
      ...
      <p>
        ...
        signals or any other mechanisms that automatically communicates your
        choice not to be tracked online. If a standard online tracking system is
      ...
      <br />
      <p>
        California Civic Code Section 1798.83, also known as the “Shine the
      ...
      <p>
        ...
        will be indicated by an updated “Revsied” date and the updated version
      ...
      <br />
      <h3 className="text-2xl font-bold">
        11. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA THAT WE COLLECT FROM
        YOU?
      </h3>
      <br />
      <p>
        ...
        that information, or delete it in some circumstances. To request a
